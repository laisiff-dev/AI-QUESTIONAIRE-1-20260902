...
(function (window) {
  ...
  class SurveyAppEngine {
    ...
    generateMockData(count = 35) {
      const departments = [
        '董事會', '校長室', '副校長室', '秘書處', '教務處', '學生事務處', '總務處', '研發與永續發展處',
        '圖書暨資訊處', '國際暨兩岸事務處', '人事室', '會計室', '稽核室', '健康與體育發展處',
        '推廣教育中心', '老化及疾病預防研究中心', '輔英附設醫院',
        '護理系', '學士後護理', '健康事業管理系', '高齡及長期照護事業系', '高齡全程照顧人才培育中心',
        '醫學檢驗生物技術系', '物理治療系', '保健營養系', '健康美容系',
        '環境工程與科學系', '職業安全衛生系', '應用化學及材料科學系', '生物科技與綠色產業系',
        '資訊科技與管理系', '休閒與遊憩事業管理系', '幼兒保育暨產業系', '應用外語系'
      ];
